...
last_modified: 2026-06-08T15:43:45Z
source_design_approved_at: 2026-06-08T15:39:33Z
---

# Implementation Plan

- [ ] 1. Add standalone doc-builder skill
  - [ ] 1.1 Create `skill/doc-builder/SKILL.md` with evidence-first workflow
  ...
  - [ ] 1.2 Add doc-builder storage, write-approval, and scope guardrails to the skill
...
- [ ] 2. Add regression tests for the doc-builder skill contract
  - [ ] 2.1 Assert required doc-builder workflow text in `test/wiki.test.js`
...
- [ ] 3. Refresh generated project knowledge
  - [ ] 3.1 Rebuild, review, and validate Raptor's own wiki after adding the skill
...
- [ ] 4. Smoke-test the agent-facing workflow
  - [ ] 4.1 Run a local smoke check that doc-builder can produce an outline from Raptor evidence
